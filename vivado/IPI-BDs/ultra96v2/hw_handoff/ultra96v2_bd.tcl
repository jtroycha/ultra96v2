...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./Development/git2/ultra96v2/vivado/IPI-BDs
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set RADIO_LED0 [ create_bd_port -dir O -from 0 -to 0 -type data RADIO_LED0 ]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_ports RADIO_LED0] [get_bd_pins axi_gpio_0/gpio_io_o]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
